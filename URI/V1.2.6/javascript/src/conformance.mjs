// IQA conformance replay — an INDEPENDENT implementation of RFC-009 §10.
//
// This file is written from RFC-009 §10/§11 alone and MUST NEVER import
...
const ORGANS = ['forge', 'tss', 'gateway'];         // §10.1 closed set
const ACTIONS = ['verify', 'audit', 'attest', 'revoke']; // §10.1 closed set
const HASH_LENGTHS = [8, 32, 64];                   // §10.2 hash-subject
...
export function parseUri(uri) {
  ...
  return {
    ...
    action_safe: action === null || action === 'verify', // §11.3
