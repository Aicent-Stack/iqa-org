//! Sovereign attestation envelope — SPEC/IQA-URI-ATTEST-v1.2.6 §5 (Ed25519,
...
//! not **create** one. Verifying is not trusting (RFC-009 §10.4).
...
/// Verify an envelope (fail closed, in order — SPEC §5). On success returns
/// the signer AID.
