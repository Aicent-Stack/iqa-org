...
[RFC-009 §10](https://iqa.org/RFC-009/) · §11 · stack v1.2.6
...
...
[PASS] all 35 checks passed (1 skipped)   # core install: the Ed25519 path needs the extra
...
|:---|:---|:---|
| crates.io | **`iqa-org`** | **published** — `1.2.6-alpha`. Every published version of the crate is a pre-release, so Cargo will not select it from a plain `iqa-org` requirement: write `cargo add iqa-org@1.2.6-alpha` |
